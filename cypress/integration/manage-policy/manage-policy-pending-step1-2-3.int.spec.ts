...
describe('rental protection manage policy page, pending, completed steps 1-2-3', () => {
  ...
  it('verify manage policy page, pending, steps 1-2-3 completed', () => {
    ...
    cy.get('[data-testid="pending-step-description-2"]').should('have.text', 'anabel whalen’s Lease');
