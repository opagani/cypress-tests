describe('landlord opt-in, application received, eligibility approved, invited to move in', () => {
  ...
  it('landlord opt-in, application received, eligibility approved, invited to move in', () => {
